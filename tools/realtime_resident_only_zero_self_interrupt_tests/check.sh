...
rg -qx 'eligible_evidence=1' "$output"
rg -qx 'confirmed_interruptions=0' "$output"
rg -qx 'provider_interrupts=0' "$output"
rg -qx 'provider_cancels=0' "$output"
rg -qx 'runtime_clear_decisions=0' "$output"
rg -qx 'host_playback_clears=0' "$output"
rg -qx 'generation_changes=0' "$output"
rg -qx 'lease_changes=0' "$output"
rg -qx 'false_turns=0' "$output"
...
rg -q 'r823_positive_control_eligible=[1-9][0-9]*' "$output"
rg -qx 'r823_positive_control_confirmed=0' "$output"
rg -qx 'r823_positive_control_provider_interrupts=0' "$output"
