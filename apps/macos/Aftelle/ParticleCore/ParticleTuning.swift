...
struct ParticleTuning: Codable, Equatable {
    ...
    enum Engine {
        ...
        static let expressionResponseCompression: Float = 3
        static let expressionBrightnessResponseGain: Float = 2
        static let expressionSaturationResponseGain: Float = 2
        static let expressionTemperatureResponseGain: Float = 1.8
        static let expressionEnergyResponseGain: Float = 2.1
        static let expressionMotionResponseGain: Float = 2
        static let expressionDiffusionResponseGain: Float = 2
        static let expressionBrightnessRange: ClosedRange<Float> = 0.70...1.25
        static let expressionSaturationRange: ClosedRange<Float> = 0.65...1.20
        static let expressionTemperatureRange: ClosedRange<Float> = -0.15...0.15
        static let expressionEnergyRange: ClosedRange<Float> = 0.70...1.25
        static let expressionMotionRange: ClosedRange<Float> = 0.75...1.20
        static let expressionDiffusionRange: ClosedRange<Float> = 0.75...1.25
