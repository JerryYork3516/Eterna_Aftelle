...
- **现在在做**:R8.3.1 True Near-end Opening Detection — PASS / FROZEN
- **上一步刚完成**:R8.3.1 production-chain true near-end 已产生合法 acoustic eligibility，R8.2.3 零 self-interrupt 不变量保持
- **当前卡在**:无
- **下一步**:只允许进入 R8.3.2 confirmed interrupt / cancel / playback clear；真机与 live Qwen 仍走 Human Gate
- **本轮范围**:R0–R8.3.1 已冻结；不回头改冻结事实，不提前实现 R8.3.2～R8.5、R9 或 R10
