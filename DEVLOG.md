...
- **现在在做**:Stage 7.5.11-A1 provider-neutral Speech Route 完成
- **上一步刚完成**:A0 冻结正式语音主链与 A6 迁移边界
- **当前卡在**:无
- **下一步**:可在新任务中进入 `7.5.11-A2`
- **本轮范围**:只新增 provider-neutral ASR / TTS 契约、RuntimeCore generation / 正式 turn 必要接线、聚焦测试与文档；不实现厂商 Adapter、不改 DR / Store schema、不进入 A6
