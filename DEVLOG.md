...
- **现在在做**:R8.4.1 Double-talk Acoustic Determination — PASS / FROZEN
- **上一步刚完成**:正式 production AEC 链已冻结 render + near-end double-talk detection、source-gate open 与 acoustic eligibility，并保持 resident-only 全零不变量
- **当前卡在**:无
- **下一步**:只允许进入 R8.4.2 Turn Completion；真机与 live Qwen 仍走 Human Gate
- **本轮范围**:R0–R8.4.1 已冻结；不回头改冻结事实，不提前实现 R8.4.2–R8.4.4、R8.5、R9 或 R10
